...
toilet -f big -F gay "BONCOT97v1" 
echo ""      
echo "\033[32;1mAuthor : Mr.BONCOT97 " 
echo "\033[35;1mTeam : BONCOT CYBER TEAM"
echo "\033[33;1mKontak Me :  0859152937421"
echo "\033[31;1mSubcribe Youtube:"
echo "\033[33;1mBoncot Cyber Team" "\033[32;1m&" "\033[36;1mIndonesia Security Lite"
echo "\033[34;1m[============================[>"
sleep 1
echo ""
...
echo "[===============================================]>"
echo $red "9.> Nyari CreditCard buat Carding"
echo "[===============================================]>"
...
echo "[===============================================]>"
echo $purple "17.> Download script deface orang"
echo "[===============================================]>"
...
echo "[===============================================]>"
echo "\033[32;1m"
read -p "[root@Tools-BONCOT97v1:~#" bro

if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "Mr.BONCOT97" | lolcat
cd module
php tp.php
fi
...
then
clear
toilet -f slant --gay "Mr.BONCOT97"
cd module
php kfc.php
fi
...
then
clear
toilet -f mono12 -F gay "Mr.BONCOT97"
cd module
php phd.php
fi
...
then
clear
toilet -f slant -F gay "Mr.BONCOT97" 
...
then
clear
toilet -f standard -F gay "Mr.BONCOT97" 
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "MrBONCOT97" | lolcat
figlet -f slant MrBONCOT97
echo "\033[37;1m"
...
then
clear
cowsay -f sheep.cow "MrBONCOT97" | lolcat
figlet "Mr.BONCOT97" | lolcat
sleep 1
cd
cd module
...
echo "\033[32;1mauthor: Mr.BONCOT97"
echo "\033[33;1mTeam: Boncot Cyber Team"
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "MrBONCOT97" 
figlet "Mr.BONCOT97" | lolcat
apt update && apt upgrade
apt install python2
apt install python
...
then
clear
toilet -f big -F gay "Mr.BONCOT97 " | lolcat
sleep 1
...
then
clear
toilet -f big -F gay " Mr.BONCOT97 "
sleep 1
apt update && apt upgrade
apt install wget
mkdir ngrok
